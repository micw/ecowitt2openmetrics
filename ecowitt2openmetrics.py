...
def handle_request(data):
    ...
    addMetric(metrics,data,"windspeedmph",1,"wind_speed", { "sensor": sensor, "time": "instant" })
    addMetric(metrics,data,"windgustmph",1,"wind_speed", { "sensor": sensor, "time": "gust" })
    addMetric(metrics,data,"maxdailygust",1,"wind_speed", { "sensor": sensor, "time": "day" })
